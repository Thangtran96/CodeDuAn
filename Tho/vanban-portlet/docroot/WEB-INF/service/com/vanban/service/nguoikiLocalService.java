...
/**
 * Provides the local service interface for nguoiki. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nguye
 * @see nguoikiLocalServiceUtil
...
public interface nguoikiLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link nguoikiLocalServiceUtil} to access the nguoiki local service. Add custom service methods to {@link com.vanban.service.impl.nguoikiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
