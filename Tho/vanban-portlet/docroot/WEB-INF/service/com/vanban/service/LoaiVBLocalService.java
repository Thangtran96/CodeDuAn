...
/**
 * Provides the local service interface for LoaiVB. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author nguye
 * @see LoaiVBLocalServiceUtil
...
public interface LoaiVBLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LoaiVBLocalServiceUtil} to access the loai v b local service. Add custom service methods to {@link com.vanban.service.impl.LoaiVBLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
