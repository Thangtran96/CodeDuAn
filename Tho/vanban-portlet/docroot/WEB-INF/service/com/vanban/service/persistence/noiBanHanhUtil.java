...
/**
 * The persistence utility for the noi ban hanh service. This utility wraps {@link noiBanHanhPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class noiBanHanhUtil {
	 ...
	 */
	public static void clearCache(noiBanHanh noiBanHanh) {
		getPersistence().clearCache(noiBanHanh);
	}
	 ...
	 */
	public static List<noiBanHanh> findWithDynamicQuery(
	 ...
	 */
	public static noiBanHanh update(noiBanHanh noiBanHanh)
		throws SystemException {
		return getPersistence().update(noiBanHanh);
	}
	...
	public static noiBanHanh update(noiBanHanh noiBanHanh,
		...
		return getPersistence().update(noiBanHanh, serviceContext);
	}
	...
	*/
	public static void cacheResult(com.vanban.model.noiBanHanh noiBanHanh) {
		getPersistence().cacheResult(noiBanHanh);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(noiBanHanhs);
	}
	...
	*/
	public static com.vanban.model.noiBanHanh create(long noiBHId) {
		return getPersistence().create(noiBHId);
	}
	...
	*/
	public static com.vanban.model.noiBanHanh remove(long noiBHId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vanban.NoSuchnoiBanHanhException {
		return getPersistence().remove(noiBHId);
	}

	public static com.vanban.model.noiBanHanh updateImpl(
		com.vanban.model.noiBanHanh noiBanHanh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(noiBanHanh);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vanban.model.noiBanHanh findByPrimaryKey(long noiBHId)
		throws com.liferay.portal.kernel.exception.SystemException,
			com.vanban.NoSuchnoiBanHanhException {
		return getPersistence().findByPrimaryKey(noiBHId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.vanban.model.noiBanHanh fetchByPrimaryKey(long noiBHId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().fetchByPrimaryKey(noiBHId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.vanban.model.noiBanHanh> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static noiBanHanhPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (noiBanHanhPersistence)PortletBeanLocatorUtil.locate(com.vanban.service.ClpSerializer.getServletContextName(),
					noiBanHanhPersistence.class.getName());

			ReferenceRegistry.registerReference(noiBanHanhUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(noiBanHanhPersistence persistence) {
	}

	private static noiBanHanhPersistence _persistence;
}