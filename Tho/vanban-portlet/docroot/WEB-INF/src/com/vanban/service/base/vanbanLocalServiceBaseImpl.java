...
import com.vanban.service.vanbanLocalService;
...
/**
 * Provides the base implementation for the vanban local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.vanban.service.impl.vanbanLocalServiceImpl}.
 * </p>
 *
 * @author nguye
 ...
 * @generated
 */
public abstract class vanbanLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements vanbanLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.vanban.service.vanbanLocalServiceUtil} to access the vanban local service.
	 */
	...
	@Override
	public vanban addvanban(vanban vanban) throws SystemException {
		vanban.setNew(true);

		return vanbanPersistence.update(vanban);
	}
	 ...
	 */
	@Override
	public vanban createvanban(long vanbanId) {
		return vanbanPersistence.create(vanbanId);
	}
	...
	@Override
	public vanban deletevanban(long vanbanId)
		throws PortalException, SystemException {
		return vanbanPersistence.remove(vanbanId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public vanban deletevanban(vanban vanban) throws SystemException {
		return vanbanPersistence.remove(vanban);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(vanban.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return vanbanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return vanbanPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return vanbanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return vanbanPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public vanban fetchvanban(long vanbanId) throws SystemException {
		return vanbanPersistence.fetchByPrimaryKey(vanbanId);
	}
	 ...
	 */
	@Override
	public vanban getvanban(long vanbanId)
		throws PortalException, SystemException {
		return vanbanPersistence.findByPrimaryKey(vanbanId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return vanbanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<vanban> getvanbans(int start, int end)
		throws SystemException {
		return vanbanPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getvanbansCount() throws SystemException {
		return vanbanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public vanban updatevanban(vanban vanban) throws SystemException {
		return vanbanPersistence.update(vanban);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.vanban.model.vanban",
			vanbanLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.vanban.model.vanban");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = vanbanPersistence.getDataSource();
	...
	private vanbanLocalServiceClpInvoker _clpInvoker = new vanbanLocalServiceClpInvoker();
}