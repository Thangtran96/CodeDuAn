...
/**
 * Provides the local service interface for Khoa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hoang_000
 * @see KhoaLocalServiceUtil
...
public interface KhoaLocalService extends BaseLocalService, InvokableLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KhoaLocalServiceUtil} to access the khoa local service. Add custom service methods to {@link com.dkcb.service.impl.KhoaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
