...
import com.dkcb.service.BacsiLocalService;
...
/**
 * Provides the base implementation for the bacsi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.dkcb.service.impl.BacsiLocalServiceImpl}.
 * </p>
 *
 * @author hoang_000
 ...
 * @generated
 */
public abstract class BacsiLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements BacsiLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.dkcb.service.BacsiLocalServiceUtil} to access the bacsi local service.
	 */
	...
	@Override
	public Bacsi addBacsi(Bacsi bacsi) throws SystemException {
		bacsi.setNew(true);

		return bacsiPersistence.update(bacsi);
	}
	 ...
	 */
	@Override
	public Bacsi createBacsi(String Idbacsi) {
		return bacsiPersistence.create(Idbacsi);
	}
	...
	@Override
	public Bacsi deleteBacsi(String Idbacsi)
		throws PortalException, SystemException {
		return bacsiPersistence.remove(Idbacsi);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Bacsi deleteBacsi(Bacsi bacsi) throws SystemException {
		return bacsiPersistence.remove(bacsi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Bacsi.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return bacsiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return bacsiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return bacsiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return bacsiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Bacsi fetchBacsi(String Idbacsi) throws SystemException {
		return bacsiPersistence.fetchByPrimaryKey(Idbacsi);
	}
	 ...
	 */
	@Override
	public Bacsi getBacsi(String Idbacsi)
		throws PortalException, SystemException {
		return bacsiPersistence.findByPrimaryKey(Idbacsi);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return bacsiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Bacsi> getBacsis(int start, int end) throws SystemException {
		return bacsiPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getBacsisCount() throws SystemException {
		return bacsiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Bacsi updateBacsi(Bacsi bacsi) throws SystemException {
		return bacsiPersistence.update(bacsi);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.dkcb.model.Bacsi",
			bacsiLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.dkcb.model.Bacsi");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = bacsiPersistence.getDataSource();
	...
	private BacsiLocalServiceClpInvoker _clpInvoker = new BacsiLocalServiceClpInvoker();
}